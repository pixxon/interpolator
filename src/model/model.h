...
namespace Model
{
    class Model: public QObject
    {
        ...
        private:
            Parseval::SymbolTable* _table;
            Parseval::Evaluator* _evaluator;
            QTimer* _timer;
            Interpolate::Interpolation* _interpolator;

            Interpolate::Partition _partX;
            Interpolate::Partition _partY;
